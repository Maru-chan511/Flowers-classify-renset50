...
flags.DEFINE_string('images_dir', 
                    'E:\\codes\\resnet_fine\\dataSets\\flower_photos\\train', 
                    'Path to images (directory).')
flags.DEFINE_string('annotation_path', 
                    'E:\\codes\\resnet_fine\\dataSets\\flower_photos\\' +
                    'flowers_train_annotations.json',
                    'Path to annotation`s .json file.')
flags.DEFINE_string('output_path', 
                    'E:\\codes\\resnet_fine\\dataSets\\flower_photos\\train.record',
